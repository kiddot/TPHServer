...
import static com.android.server.config.ConfigCenter.http_work;
...
public class NettyHttpClient extends BaseService implements HttpClient {
    ...
    private static final int maxContentLength = (int) ConfigCenter.max_content_length;
    ...
    @Override
    public void request(final RequestContext context) throws Exception {
    ...
    protected void doStart(ServerListener listener) throws Throwable {
        workerGroup = new NioEventLoopGroup(http_work);
        b = new Bootstrap();
        b.group(workerGroup);
